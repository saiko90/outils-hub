...
export const TOOLS: Tool[] = [
  ...
  { slug: "budgeto", name: "budgeto", tagline: "Budget mensuel & annuel suisse (impôts, assurances, taxes)", url: "https://outils.ch/o/budgeto", cat: "Suisse", tags: ["budget", "dépenses", "revenus", "épargne", "impôts", "assurances", "serafe", "finances"], from: "#6366f1", to: "#34d399", ch: true },
  ...
  { slug: "intero", name: "intero", tagline: "Intérêts moratoires (retard de paiement, 5 %)", url: "https://outils.ch/o/intero", cat: "Suisse", tags: ["intérêts moratoires", "retard", "paiement", "facture impayée", "demeure", "5%", "recouvrement"], from: "#f59e0b", to: "#f43f5e", ch: true },
  { slug: "preo", name: "preo", tagline: "Délai de résiliation du contrat de travail (Suisse)", url: "https://outils.ch/o/preo", cat: "Suisse", tags: ["contrat de travail", "résiliation", "préavis", "congé", "licenciement", "démission", "emploi"], from: "#6366f1", to: "#f59e0b", ch: true },
  { slug: "ideo", name: "ideo", tagline: "Vérifier un numéro IDE / UID suisse (CHE)", url: "https://outils.ch/o/ideo", cat: "Suisse", tags: ["ide", "uid", "che", "numéro entreprise", "tva", "validation", "registre"], from: "#3b82f6", to: "#22d3ee", ch: true },
  { slug: "alcoolo", name: "alcoolo", tagline: "Taux d'alcoolémie estimé (Widmark) — limites suisses", url: "https://outils.ch/o/alcoolo", cat: "Santé", tags: ["alcoolémie", "alcool", "widmark", "permis", "0.5", "conduite", "promille"], from: "#f59e0b", to: "#ef4444", ch: true },
  { slug: "imca", name: "imca", tagline: "Calcul de l'IMC (indice de masse corporelle)", url: "https://outils.ch/o/imca", cat: "Santé", tags: ["imc", "bmi", "poids", "corpulence", "obésité", "santé", "masse corporelle"], from: "#22d3ee", to: "#34d399" },
  { slug: "calorio", name: "calorio", tagline: "Calories, journal alimentaire & suivi du poids", url: "https://outils.ch/o/calorio", cat: "Santé", tags: ["calories", "calorie", "journal alimentaire", "besoins caloriques", "métabolisme", "tdee", "macros", "suivi poids", "régime", "perte de poids", "nutrition"], from: "#22c55e", to: "#84cc16" },
  { slug: "scalc", name: "scalc", tagline: "Calculatrice scientifique + solveur d'équations + formulaire", url: "https://outils.ch/o/scalc", cat: "Calcul", tags: ["calculatrice", "scientifique", "équation", "solveur", "second degré", "trigonométrie", "logarithme", "mémoire", "maths", "formules"], from: "#6366f1", to: "#22d3ee" },
  { slug: "agendo", name: "agendo", tagline: "Générateur d'événements agenda (.ics)", url: "https://outils.ch/o/agendo", cat: "Temps", tags: ["ics", "icalendar", "agenda", "calendrier", "événement", "invitation", "google agenda", "outlook", "rappel", "vevent"], from: "#38bdf8", to: "#6366f1" },
  { slug: "schemo", name: "schemo", tagline: "Validateur JSON-LD (Schema.org)", url: "https://outils.ch/o/schemo", cat: "Web", tags: ["json-ld", "jsonld", "schema.org", "données structurées", "structured data", "seo", "rich results", "rich snippets", "google", "microdata", "balisage", "référencement"], from: "#8b5cf6", to: "#0ea5e9" },
  { slug: "sitemapo", name: "sitemapo", tagline: "Générateur de sitemap.xml + robots.txt", url: "https://outils.ch/o/sitemapo", cat: "Web", tags: ["sitemap", "sitemap.xml", "robots.txt", "seo", "référencement", "google", "indexation", "crawl", "urls", "plan du site"], from: "#0ea5e9", to: "#22c55e" },
 ...
 */
export const PRO_SLUGS = ["facturama", "rento", "legato", "budgeto", "lamalo", "salaro", "resilio", "alloco", "intero", "preo", "ideo", "tvaflash", "ibano", "capimmo", "avso", "prorato", "teleco", "lettro"];
