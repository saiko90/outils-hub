...
export const UI: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    toGrid: "Tous les outils", favTitle: "Favoris", recentTitle: "Récemment ouverts", pin: "Ajouter aux favoris", unpin: "Retirer des favoris", suggestTitle: "Suggestions", footAbout: "À propos", footPrivacy: "Confidentialité", swissLinked: "Outils suisses complémentaires", goFurther: "Pour aller plus loin — outil métier suisse", catProTitle: "Outils métier pros", catProSub: "Conçus pour les indépendants et PME : conformes aux normes suisses, résultat prêt pour ta comptabilité.",
  },
  de: {
    ...
    toGrid: "Alle Tools", favTitle: "Favoriten", recentTitle: "Zuletzt geöffnet", pin: "Zu Favoriten hinzufügen", unpin: "Aus Favoriten entfernen", suggestTitle: "Vorschläge", footAbout: "Über uns", footPrivacy: "Datenschutz", swissLinked: "Ergänzende Schweizer Tools", goFurther: "Einen Schritt weiter — Schweizer Business-Tool", catProTitle: "Business-Tools für Profis", catProSub: "Für Selbstständige und KMU: normkonform, Ergebnis bereit für die Buchhaltung.",
  },
  en: {
    ...
    toGrid: "All tools", favTitle: "Favourites", recentTitle: "Recently opened", pin: "Add to favourites", unpin: "Remove from favourites", suggestTitle: "Suggestions", footAbout: "About", footPrivacy: "Privacy", swissLinked: "Related Swiss tools", goFurther: "Go further — Swiss business tool", catProTitle: "Pro business tools", catProSub: "Built for freelancers and SMEs: Swiss-compliant, result ready for your accounting.",
  },
};
