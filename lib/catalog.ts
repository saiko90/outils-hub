...
export const TOOLS: Tool[] = [
  ...
  { slug: "scalc", name: "scalc", tagline: "Calculatrice scientifique (trigo, log, √, !)", url: "https://outils.ch/o/scalc", cat: "Calcul", tags: ["calculatrice", "scientifique", "trigonométrie", "logarithme", "racine", "factorielle", "maths"], from: "#6366f1", to: "#22d3ee" },
