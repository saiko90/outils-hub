...
export const UI: Record<Lang, Record<string, string>> = {
  ...
  de: {
    ...
    toGrid: "Alle Tools", favTitle: "Favoriten", recentTitle: "Zuletzt geöffnet", pin: "Zu Favoriten hinzufügen", unpin: "Aus Favoriten entfernen", suggestTitle: "Vorschläge", footAbout: "Über uns", footPrivacy: "Datenschutz", swissLinked: "Ergänzende Schweizer Tools", catProTitle: "Business-Tools für Profis", catProSub: "Für Selbstständige und KMU: normkonform, Ergebnis bereit für die Buchhaltung.",
  },
  en: {
