...
export const COPY: Record<LLang, LandingCopy> = {
  fr: {
    ...
    refBanner: "Un ami t'invite : 1 mois de calorio Pro t'attend à l'inscription.",
  ...
  de: {
    ...
    refBanner: "Eine Freundin lädt dich ein: 1 Monat calorio Pro wartet bei der Anmeldung auf dich.",
  ...
  en: {
    ...
    refBanner: "A friend invited you: 1 month of calorio Pro is waiting when you sign up.",
